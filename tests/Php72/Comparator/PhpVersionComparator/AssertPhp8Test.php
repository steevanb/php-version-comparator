...
final class AssertPhp8Test extends TestCase
{
    public function testAssertIsPhp8(): void
    {
        ...
        $this->expectExceptionMessage(
            'Version "7.2.34-26+ubuntu20.04.1+deb.sury.org+1" is not between "8.0.0" and "9.0.0".'
        );
    ...
    public function testAssertIsPhp80(): void
    {
        ...
        $this->expectExceptionCode(0);
        $this->expectExceptionMessage(
            'Version "7.2.34-26+ubuntu20.04.1+deb.sury.org+1" is not between "8.0.0" and "8.1.0".'
        );
    ...
    public function testAssertIsPhp81(): void
    {
        ...
        $this->expectExceptionCode(0);
        $this->expectExceptionMessage(
            'Version "7.2.34-26+ubuntu20.04.1+deb.sury.org+1" is not between "8.1.0" and "8.2.0".'
        );
