...
namespace Steevanb\PhpVersionCompare\Tests\Php72\PhpVersionCompare;
...
final class IsBetweenTest extends TestCase
{
    ...
    {
        static::assertTrue(PhpVersionCompare::isBetween('7.2', '7.3'));
    }

    public function testMinorFalse(): void
    {
        static::assertFalse(PhpVersionCompare::isBetween('7.1', '7.2'));
    }

    public function testBugfix(): void
    {
        static::assertTrue(PhpVersionCompare::isBetween('7.2.34', '7.2.35'));
    }

    public function testBugfixFalse(): void
    {
        static::assertFalse(PhpVersionCompare::isBetween('7.2.33', '7.2.34'));
    }
}
