...
namespace Steevanb\VersionComparator\Tests\Php71\Comparator\PhpVersionComparator;
...
final class AssertPhp5Test extends TestCase
{
    public function testAssertIsPhp5(): void
    {
        ...
        $this->expectExceptionMessage(
            'Version "7.1.33-42+ubuntu20.04.1+deb.sury.org+1" is not between "5.0.0" and "6.0.0".'
        );
    ...
    public function testAssertIsPhp53(): void
    {
        ...
        $this->expectExceptionCode(0);
        $this->expectExceptionMessage(
            'Version "7.1.33-42+ubuntu20.04.1+deb.sury.org+1" is not between "5.3.0" and "5.4.0".'
        );
    ...
    public function testAssertIsPhp54(): void
    {
        ...
        $this->expectExceptionCode(0);
        $this->expectExceptionMessage(
            'Version "7.1.33-42+ubuntu20.04.1+deb.sury.org+1" is not between "5.4.0" and "5.5.0".'
        );
    ...
    public function testAssertIsPhp55(): void
    {
        ...
        $this->expectExceptionCode(0);
        $this->expectExceptionMessage(
            'Version "7.1.33-42+ubuntu20.04.1+deb.sury.org+1" is not between "5.5.0" and "5.6.0".'
        );
    ...
    public function testAssertIsPhp56(): void
    {
        ...
        $this->expectExceptionCode(0);
        $this->expectExceptionMessage(
            'Version "7.1.33-42+ubuntu20.04.1+deb.sury.org+1" is not between "5.6.0" and "5.7.0".'
        );
